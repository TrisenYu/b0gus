...
type LLMcli struct {
	...
	BaseURL string `toml:"base_url" json:"base_url" mapstructure:"base_url" validate:"url"`
	...
	APIKey      string  `toml:"api_key" json:"api_key" mapstructure:"api_key" validate:"required"`

...
func rdtparserParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		22, 0, 2, 1, 0, 14, 16, 1, 0, 11, 13, 101, 0, 24, 1, 0, 0, 0, 2, 26, 1,
		...
		19, 0, 0, 25, 1, 1, 0, 0, 0, 26, 27, 5, 19, 0, 0, 27, 3, 1, 0, 0, 0, 28,
		29, 5, 19, 0, 0, 29, 5, 1, 0, 0, 0, 30, 31, 5, 19, 0, 0, 31, 7, 1, 0, 0,
		0, 32, 33, 5, 19, 0, 0, 33, 9, 1, 0, 0, 0, 34, 35, 7, 0, 0, 0, 35, 11,
		1, 0, 0, 0, 36, 37, 7, 1, 0, 0, 37, 13, 1, 0, 0, 0, 38, 43, 3, 16, 8, 0,
		39, 40, 5, 22, 0, 0, 40, 42, 3, 16, 8, 0, 41, 39, 1, 0, 0, 0, 42, 45, 1,
		0, 0, 0, 43, 41, 1, 0, 0, 0, 43, 44, 1, 0, 0, 0, 44, 15, 1, 0, 0, 0, 45,
		43, 1, 0, 0, 0, 46, 70, 5, 2, 0, 0, 47, 70, 5, 1, 0, 0, 48, 70, 5, 4, 0,
		0, 49, 70, 5, 3, 0, 0, 50, 51, 5, 6, 0, 0, 51, 70, 5, 18, 0, 0, 52, 55,
		5, 7, 0, 0, 53, 56, 5, 18, 0, 0, 54, 56, 3, 8, 4, 0, 55, 53, 1, 0, 0, 0,
		55, 54, 1, 0, 0, 0, 56, 70, 1, 0, 0, 0, 57, 58, 5, 5, 0, 0, 58, 59, 5,
		21, 0, 0, 59, 60, 3, 0, 0, 0, 60, 61, 5, 20, 0, 0, 61, 62, 3, 2, 1, 0,
		...
		0, 71, 72, 3, 2, 1, 0, 72, 73, 5, 20, 0, 0, 73, 74, 3, 10, 5, 0, 74, 76,
		5, 24, 0, 0, 75, 77, 3, 14, 7, 0, 76, 75, 1, 0, 0, 0, 76, 77, 1, 0, 0,
		0, 77, 78, 1, 0, 0, 0, 78, 80, 5, 25, 0, 0, 79, 81, 5, 23, 0, 0, 80, 79,
		1, 0, 0, 0, 80, 81, 1, 0, 0, 0, 81, 19, 1, 0, 0, 0, 82, 83, 3, 0, 0, 0,
		83, 85, 5, 20, 0, 0, 84, 86, 3, 18, 9, 0, 85, 84, 1, 0, 0, 0, 86, 87, 1,
		0, 0, 0, 87, 85, 1, 0, 0, 0, 87, 88, 1, 0, 0, 0, 88, 90, 1, 0, 0, 0, 89,
		91, 5, 17, 0, 0, 90, 89, 1, 0, 0, 0, 90, 91, 1, 0, 0, 0, 91, 21, 1, 0,
...
const (
	...
	RDTparserINTEGER       = 16
	RDTparserSTRICT        = 17
	RDTparserINT_NUMBER    = 18
	RDTparserID            = 19
	RDTparserCOLON         = 20
	RDTparserPOINT_TO      = 21
	RDTparserCOMMA         = 22
	RDTparserSEMICOLON     = 23
	RDTparserLPAREN        = 24
	RDTparserRPAREN        = 25
	RDTparserWS            = 26
	RDTparserLINE_COMMENT  = 27
)
...
func (s *Field_typeContext) BYTES() antlr.TerminalNode {
	return s.GetToken(RDTparserBYTES, 0)
}

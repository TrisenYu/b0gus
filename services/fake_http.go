...
func (hs *HTTPservConf) httpHook(c *gin.Context) {
	...
	c.Request.UserAgent()
	_ = hs.db.CreateOrUpdateItemsInSeq([]databases.DBstruct{
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
	<url><loc>http://`+c.Request.Host+`/log/data.php</loc></url>
</urlset>`)
	})
	// TODO: 1. provide a link to return a fake documentation (e.g. .doc, .pdf) but actually a Trojan
	// 		Trojan should be generated by yourself
